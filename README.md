...
#### Open [file `solution.txt`](solution.txt) To follow the terminal command. Solutions divided into five steps :
...
#### Documentation can be found on :[https://github.com/Pradeep-6524/Celestial-Bodies-Database](https://github.com/Pradeep-6524/Celestial-Bodies-Database) 
...
## Instructions
For this project, you need to log in to PostgreSQL with psql to create your database. Do that by entering `psql --username=freecodecamp --dbname=postgres` in the terminal. Make all the tests below pass to complete the project.
